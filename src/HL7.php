 ...
 *
 */
class HL7 implements DefaultControlCharacters
{
    /**
    ...
    {
        $this->hl7Globals['SEGMENT_SEPARATOR'] = self::DEFAULT_SEGMENT_SEPARATOR;
        $this->hl7Globals['FIELD_SEPARATOR'] = self::DEFAULT_FIELD_SEPARATOR;
        $this->hl7Globals['NULL'] = self::DEFAULT_NULL;
        $this->hl7Globals['COMPONENT_SEPARATOR'] = self::DEFAULT_COMPONENT_SEPARATOR;
        $this->hl7Globals['REPETITION_SEPARATOR'] = self::DEFAULT_REPETITION_SEPARATOR;
        $this->hl7Globals['ESCAPE_CHARACTER'] = self::DEFAULT_ESCAPE_CHARACTER;
        $this->hl7Globals['SUBCOMPONENT_SEPARATOR'] = self::DEFAULT_SUBCOMPONENT_SEPARATOR;
        $this->hl7Globals['HL7_VERSION'] = self::DEFAULT_HL7_VERSION;
    }
