...
class PV1 extends Segment
{
     ...
     *
     * A Accident
     * E Emergency US UB92 code “1”
     * L Labor and Delivery
     * R Routine
     * N Newborn (Birth in healthcare facility) US UB92 code “4”
     * U Urgent US UB92 code “2”
     * C Elective US
     */
     ...
     *   // CAR Cardiac Service
     */
    public function setHospitalService($value = 'MED', int $position = 10)
    {
        return $this->setField($position, $value);
    }
